...
import com.okay.face.model.Utils;
...
public class MTCNN {
    ...
    // 模型路径
    private static final String MODEL_FILE = "file:///android_asset/mtcnn_20180726.pb";
    // 模型各层名称
     ...
     *   人脸框
     */
    public Vector<Face> detectFaces(Bitmap bitmap, int minFaceSize) {
        long t_start = System.currentTimeMillis();
        //【1】PNet generate candidate boxes
        Vector<Face> boxes = PNet(bitmap, minFaceSize);
        ...
        this.fps = 1000 / this.costTime;

        Log.i(TAG, "MTCNN Detect Faces Cost Time:" + Double.toString(this.costTime));
